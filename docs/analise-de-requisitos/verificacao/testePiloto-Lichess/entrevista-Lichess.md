...
| 13 | Apresenta os participantes da entrevista? | ✔ |  |
...
| 20 | É descrita a técnica de entrevista utilizada? | ✔ |  |
| 21 | É descrita as perguntas que serão feitas na entrevista? | ✔ |  |

<figcaption align="center">Tabela 2: Critérios específicos do artefato. (Fonte: Autores, 2022)</figcaption>

## Conclusão
<p align="justify">O artefato contém um pequeno erro na formatação da página, no que se refere ao texto está em formato justificado. Falta também a gravação da entrevista, mas fora isto, está completo.</p>
